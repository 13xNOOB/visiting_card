...
<body>
    <div style="display: flex; justify-content: center; align-items: center;">
        <h1 style="margin-right: 20px;">Your Visiting Cards</h1>
    ...
    <div class="container" style="margin: 0 auto;">
        @if ($visitingCards && $visitingCards->count() > 0)
            @foreach ($visitingCards as $visitingCard)
                <div class="box" style="width:60%;margin: 0 auto;">
                    ...
                    <div class="text-center mt-4">
                        <button class="btn btn-primary" onclick="location.href='{{ route('viewpdf', ['id' => $visitingCard->id]) }}'" >View Card</button>
                        <button class="btn btn-success" onclick="location.href='{{ route('downloadpdf', ['id' => $visitingCard->id]) }}'">Download Card</button>
                    </div>
                    <div>
                        <br>
                    </div>
